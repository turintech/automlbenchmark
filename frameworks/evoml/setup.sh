...
${HERE}/venv/bin/python -m pip install metaml[all] evoml_client[full]==0.1.6 --extra-index-url https://chatterquant:yUzy46I\!eu5v@nexus.dataspartan.com/repository/pypi-external/simple
echo 'ec DONE'
